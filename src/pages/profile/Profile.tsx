...
export default function Profile() {
  ...
  // 🆕 FIXED: Add proper type for useRef
  ...
  // 🆕 FIXED: Add proper type for userProfile
  ...
  const handleImageClick = () => {
    // 🆕 FIXED: Safe click with optional chaining
  ...
  // 🆕 FIXED: Address from API with proper typing
      ...
      <div className="flex-1 flex items-start justify-center p-4 md:p-8">
        ...
        {activeTab === "orders" && (
          <div className="w-full text-center text-gray-600 mt-10">
            ...
            {user?.orders && user.orders.length > 0 ? <OrdersTable /> : <p>No orders yet.</p>}
          </div>
        )}
      </div>
    </div>
